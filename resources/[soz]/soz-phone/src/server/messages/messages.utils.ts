...
export async function getFormattedMessageConversations(identifier: string): Promise<MessageConversation[]> {
...
export async function createMessageGroupsFromPhoneNumber(
    ...
    const updatedAt = existingConversation ? existingConversation.updatedAt : new Date().getTime();
