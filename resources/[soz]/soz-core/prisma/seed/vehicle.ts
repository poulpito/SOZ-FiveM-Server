...
const vehicleJobList: [JobType, string, number][] = [
    ...
    [JobType.LSPD, 'lspd20', 0],
    [JobType.LSPD, 'lspd30', 0],
    [JobType.LSPD, 'lspd50', 0],
    [JobType.LSPD, 'lspd51', 0],
