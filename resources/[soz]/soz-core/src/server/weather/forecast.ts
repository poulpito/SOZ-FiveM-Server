...
export const Winter: Forecast = {
    EXTRASUNNY: {},
    CLEAR: { SNOW: 20, XMAS: 20, BLIZZARD: 10, FOGGY: 25, SNOWLIGHT: 25 },
    NEUTRAL: {},
    SMOG: {},
    FOGGY: { SNOW: 20, XMAS: 20, BLIZZARD: 10, CLEAR: 25, SNOWLIGHT: 25 },
    OVERCAST: { CLEAR: 100 },
    CLOUDS: {},
    CLEARING: {},
    RAIN: {},
    THUNDER: {},
    SNOW: { XMAS: 20, BLIZZARD: 10, CLEAR: 25, FOGGY: 25, SNOWLIGHT: 20 },
    BLIZZARD: { SNOW: 20, XMAS: 20, CLEAR: 25, FOGGY: 25, SNOWLIGHT: 10 },
    SNOWLIGHT: { SNOW: 20, BLIZZARD: 10, CLEAR: 25, FOGGY: 25, XMAS: 20 },
    XMAS: { SNOW: 20, BLIZZARD: 10, CLEAR: 25, FOGGY: 25, SNOWLIGHT: 20 },
    HALLOWEEN: {},
};
