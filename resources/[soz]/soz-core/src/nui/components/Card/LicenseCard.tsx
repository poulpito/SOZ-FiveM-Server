            ...
            <div className="flex h-full">
                <div className="pt-[48%] pl-[7.5%] flex w-[52%]">
                    <div>
                        ...
                        <p className="leading-none text-m">{player.charinfo.lastname.toUpperCase()}</p>
                    </div>
                    <div className="pl-4">
                        <h3 className="text-sm leading-none">Prénom(s)</h3>
                        <p className="leading-none text-m">{player.charinfo.firstname.toUpperCase()}</p>
                    </div>
                </div>
                <div className="pl-[10%] flex-grow pr-[5%] pt-[12%] pb-[8.5%] h-full flex flex-col justify-between">
                    <div className="flex items-center justify-between">
                        ...
                        <div className="w-[47%] text-center font-bold text-xs uppercase">
