...
export const BossShop: (ShopConfig & { job: JobType })[] = [
    ...
    },
    {
        ...
        products: [
            ...
            { id: 'stretcher', type: 'item', price: 300 },
            { id: 'wheelchair', type: 'item', price: 300 },
            { id: 'morphine', type: 'item', price: 20 },
        ],
        orders: {
    ...
    },
    {
        name: 'lsmc_north',
        job: JobType.LSMC,
        zone: new BoxZone([1828.88, 3675.5, 38.28], 2.6, 1.0, {
            heading: 300.15,
            minZ: 37.28,
            maxZ: 39.28,
        }),
