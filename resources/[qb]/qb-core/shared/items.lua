...
QBShared.Items = {
    ...
    ['carpe_feur'] = {
     ...
     ['bar_a_thym'] = {
        ...
        ['illustrator'] = ".Berson",
        ['fishing_area'] = {'littoral','north_sea','south_sea','big_lake','little_lake','river','canals'},
        ['fishing_weather'] = {'CLEAR','CLEARING','EXTRASUNNY','SNOW','SNOWLIGHT','XMAS','BLIZZARD','FOGGY','SMOG','RAIN','OVERCAST','CLOUDS','THUNDER','BLIZZARD'},
        ['fishing_period'] = {'always'},
        ['fishman_status'] = 'clean',
        ['min_weight'] = 500,
        ['max_weight'] = 2600,
